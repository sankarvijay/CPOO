...
public final class Main {
	...
	public static void main(String[] args){
		...
		try{
			...
			Employe e4 = ef.createEmploye("Vijay",25.00,60);
			...
			System.out.println(e1+", Le salaire est de : "+e1.salaireHebdo()+" euros !");
			System.out.println(e2+", Le salaire est de : "+e2.salaireHebdo()+" euros !");
			...
			System.out.println(e5+", Le salaire est de : "+e5.salaireHebdo()+" euros !");
